...
export default function QuizDetailsPage() {
  ...
  if (error || !quiz)
    return (
      <div className="p-6 text-center text-red-500">{error || "Quiz not found."}</div>
    );
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <motion.div variants={cardVariants} className="bg-orange-50 border border-orange-100 rounded-xl p-4 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <motion.div variants={cardVariants} className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex items-center justify-between">
            ...
            <motion.div variants={cardVariants} className="flex items-center gap-2 p-4">
              <input
                type="checkbox"
      ...
      <UpdateQuizModal isOpen={showModal} onClose={closeModalUpdate} onSubmit={updateQuiz} defaultValues={{ title: quiz?.title }} loading={modalLoading} />
    </AnimatePresence>
  );
}
